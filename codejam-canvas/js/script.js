window.addEventListener('load', function () {
    ...
    document.querySelector('.switch-png').addEventListener('change', onChage_png);
    document.querySelector('.switch-4x4').addEventListener('change', onChage_4x4);
    document.querySelector('.switch-32x32').addEventListener('change', onChage_32x32);
